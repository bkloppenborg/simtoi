...
{
	CLevmar::Init(worker_thread);

//	// Get a copy of the original data, load it into memory.
//	int nData = mWorkerThread->GetNDataSets();
//	for(int data_set = 0; data_set < nData; data_set++)
//		mData.push_back(mWorkerThread->GetData(data_set));
}
...
//		try
//		{
//			mWorkerThread->ReplaceData(i, t_data);
//		}
...
//		mWorkerThread->SetFreeParameters(mParams, mNParams, true);
//
...
//			mWorkerThread->GetChi(data_set, mResiduals, nData);
//
//			tmp_chi2 = 0;
//			tmp = 0;

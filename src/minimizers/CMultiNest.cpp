...
//	int nData = minimizer->mWorkerThread->GetNData();
//
//	minimizer->mWorkerThread->SetFreeParameters(params, npars, true);
...
//		tmp += minimizer->mWorkerThread->GetLogLike(data_set);
//	}
//
//	// Add in the priors.
////	tmp += minimizer->mWorkerThread->GetFreeParameterPriorProduct();
//
//	// Get the scaled parameter values
//	minimizer->mWorkerThread->GetFreeParameters(params, npars, true);
//
//	lnew = tmp;
}

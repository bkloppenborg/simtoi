...
CPositionOrbit::CPositionOrbit()
{
	...
	addParameter("Omega", 0, 0, 360, false, 1, "Ascending node PA (degs)", "Position angle of the ascending node (degrees).");
	addParameter("inclination", 0, -180, 180, false, 1, "Inclination (degs)", "Inclination measured from the plane of the sky (degrees).");
	addParameter("omega", 0, 0, 360, false, 1, "Argument of periapsis (degs)", "Argument of periapsis (degrees).");
	addParameter("alpha", 0, 0, 10, false, 1, "Semi-major axis (mas)", "Orbital semi-major axis");
	addParameter("e", 0, 0, 1, false, 0.1, "Eccentricity", "Orbital eccentricity");
	addParameter("T", 0, 0, 1000, false, 10, "Time of periastron (days)", "Time of periastron passage");
	addParameter("P", 1, 0, 360, false, 1, "Orbital period (days)", "Orbital period");
}
